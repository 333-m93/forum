...
func StartServer() {
	...
	mux.HandleFunc("/admin/users/ban", adminBanHandler)
	mux.HandleFunc("/admin/users/unban", adminUnbanHandler)
	mux.HandleFunc("/admin/messages/delete", adminDeleteMessageHandler)
